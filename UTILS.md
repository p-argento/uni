...
- ..
Comment
- requires solid background in calculus and linear algebra; lectures are hard but recorded (available in e-learning); project is really hard; probably the hardest course;
