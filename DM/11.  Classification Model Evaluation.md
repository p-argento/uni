...
**ROC**
It was originally developed in 1950s to analyze noisy signals, showing the trade-off between positive hits and false alarms. The performance of each classifier is represented as a point on the ROC Curve.
The curve plots
- True Positive Rate (on x), also called 'recall' or 'sensitivity'
- False Positive Rate (on y), also called probability of false alarm

$$TPR = \frac{TP}{TP+FN}\qquad FPR=\frac{FP}{TP+FN} $$
