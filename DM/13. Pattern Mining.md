...
Steps
1. Given two frequent (k-1)-itemsets
	1. (if k=2) merge if they have a common element
	2. (if k>2) merge if their first (k-2) items are identical
...
Prune.
ABCE because ACE and BCE are infrequent
ABDE because ADE is infrequent
